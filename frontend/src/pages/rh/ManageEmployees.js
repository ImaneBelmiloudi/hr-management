    ...
    try {
      ...
      if (isEditing) {
        ...
        const updatedData = {
          ...
          employee_id: apiData.employee_id || response.data.employee_id || response.data.id || currentEmployeeId,
          position: apiData.position || response.data.position,
          grade: formData.grade || apiData.grade || response.data.grade || 'N/A',
          hire_date: apiData.hire_date || response.data.hire_date,
